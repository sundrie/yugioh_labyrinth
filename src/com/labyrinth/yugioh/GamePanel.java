...
//        System.out.println(infoPanelContainer);
    ...
    public void generateLabyrinth(Graphics g){
        ...
        int grid[][] = {
                {1,8,8,0,4,1,4,1,4,1,8,8,8,4},
                {2,7,5,0,0,7,5,7,0,5,3,5,0,3},
                {11,5,6,4,5,3,5,7,2,3,1,3,0,11},
                {11,2,4,5,0,0,3,2,4,1,7,1,3,11},
                {11,8,3,2,0,8,4,1,7,0,5,3,1,11},
                {11,5,0,4,0,5,0,0,7,0,2,0,7,11},
                {11,3,1,7,0,5,3,2,6,0,4,1,6,11},
                {11,1,3,5,3,2,4,1,0,0,7,2,4,11},
                {11,0,1,3,1,4,5,7,1,7,2,8,7,11},
                {1,0,7,1,7,0,5,7,5,0,0,7,5,4},
                {2,6,6,6,3,2,3,2,3,2,0,6,6,3}
        };
